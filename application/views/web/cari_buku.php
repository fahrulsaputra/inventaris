        ...
        <body>
            ...
            <div class="navbar navbar-default">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <div class="nav navbar-nav navbar-right">
                        <form class="navbar-form navbar-left" role="search" action="<?php echo site_url('web/cari_inventaris');?>" method="post">
                            <div class="form-group">
                                <input type="text" name="cari" class="form-control" placeholder="Cari Inventaris">
                            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 ">
                        <legend>Pencarian Inventaris</legend>
