...
class Web extends CI_Controller{
    ...
    function __construct(){
        parent::__construct();
        $this->load->model(array('m_inventaris','m_petugas'));
    ...
    function cari_inventaris(){
        ...
        $data['hasil']=$this->m_inventaris->cari($cari)->result();
        $data['title']="Pencarian Inventaris";
        $this->load->view('web/cari_inventaris',$data);
    }
